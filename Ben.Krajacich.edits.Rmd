...
# Summary of Skills
  ...
  *	Fluency in R, with extensive experience in data manipulation/wrangling of complex data sets, GIS/mapping, analysis of next-generation sequencing data sets (16S microbiome/RNA-seq/WGS), machine learning, dashboard development for field projects with flexdashboard/Shiny/REDcap, and extraction of weather data for climatic data.
 ...
 * **Krajacich BJ**, Sullivan M, Faiman R, Veru L, Graber L, Lehmann T. Induction of long-lived potential aestivation states in laboratory An. gambiae mosquitoes. *In press* **Parasites and Vectors**. Pre-print available. bioRxiv. 2020. doi:https://doi.org/10.1101/2020.04.14.031799
 ...
 * Faiman R, Yaro AS, Diallo M, Dao A, Samake D, Sonogo ZL, Sullivan M, Krishna A, **Krajacich BJ**, Lehmann T. Quantifying flight aptitude variation in wild A. gambiae s.l. in order to identify long-distance migrants. *In press* Malaria Journal. Pre-print available. bioRxiv. 2020. doi:https://doi.org/10.1101/2020.03.03.975243
